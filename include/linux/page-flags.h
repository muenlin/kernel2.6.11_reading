...
#define TestClearPageLRU(page)	test_and_clear_bit(PG_lru, &(page)->flags) /*Clear a bit and return its old value*/
/*https://www.kernel.org/doc/htmldocs/kernel-api/API-test-and-clear-bit.html*/
